...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Percentage of Correct Dog Breed:", results_stats_dic['pct_correct_breed'])
    print("Percentage of Correctly Classified Dogs:", results_stats_dic['pct_correct_dogs'])
    print("Percentage of Correctly Classified Not-Dogs:", results_stats_dic['pct_correct_notdogs'])
